...
for i in range(n_models):
    ...
    seed_value = np.random.randint(1, 99999)
    ...
    X_train, X_val, y_train, y_val = train_test_split(features_pca, labels, test_size=0.25, random_state=seed_value)
